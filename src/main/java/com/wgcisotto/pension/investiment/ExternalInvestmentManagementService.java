...
public class ExternalInvestmentManagementService implements InvestmentManagementService {
    ...
    @Override
    public void addFunds(Account account, BigDecimal investimentAmount, Currency investmentCcy) throws IllegalArgumentException {
        if (investmentCcy != Currency.getInstance("USD")){
            throw new IllegalArgumentException("Only USD accounts are supported");
        }
        account.setAvailableCash(account.getAvailableCash().add(investimentAmount, MATH_CONTEXT));
    }

    @Override
    public boolean buyInvestmentFund(Account account, String fundId, BigDecimal investmentAmount) throws IllegalArgumentException, IOException {
    ...
    @Override
    public boolean sellInvestmentFund(Account account, String fundId, BigDecimal investmentAmount) throws IllegalArgumentException, IOException {
    ...
    boolean executeInvestmentTransaction(String fundId, BigDecimal investmentAmount,
